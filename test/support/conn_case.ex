defmodule VendingWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use VendingWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import VendingWeb.ConnCase

      alias VendingWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint VendingWeb.Endpoint
    end
  end

  setup tags do
    Vending.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Vending.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Vending.Accounts.generate_user_session_token(user)
